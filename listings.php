...
<div id=rides>
  ...
  if ($result_rides_stmt = $mysqli->prepare("SELECT `carpool_id`, `leave_date`, `from_lat`, `from_long`, `destination_lat`, `destination_long` FROM `rides` WHERE open_to_passengers = TRUE")) {
